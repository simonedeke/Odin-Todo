...
/***/ "./src/images sync \\.(png%7Csvg%7Cjpg%7Cjpeg%7Cgif)$":
/*!*************************************************************************!*\
  !*** ./src/images/ sync nonrecursive \.(png%7Csvg%7Cjpg%7Cjpeg%7Cgif)$ ***!
  \*************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("var map = {\n\t\"./add.png\": \"./src/images/add.png\"\n};\n\n\nfunction webpackContext(req) {\n\tvar id = webpackContextResolve(req);\n\treturn __webpack_require__(id);\n}\nfunction webpackContextResolve(req) {\n\tif(!__webpack_require__.o(map, req)) {\n\t\tvar e = new Error(\"Cannot find module '\" + req + \"'\");\n\t\te.code = 'MODULE_NOT_FOUND';\n\t\tthrow e;\n\t}\n\treturn map[req];\n}\nwebpackContext.keys = function webpackContextKeys() {\n\treturn Object.keys(map);\n};\nwebpackContext.resolve = webpackContextResolve;\nmodule.exports = webpackContext;\nwebpackContext.id = \"./src/images sync \\\\.(png%7Csvg%7Cjpg%7Cjpeg%7Cgif)$\";\n\n//# sourceURL=webpack://odin-todo/./src/images/_sync_nonrecursive_\\.(png%257Csvg%257Cjpg%257Cjpeg%257Cgif)$?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _toDoManager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./toDoManager.js */ \"./src/toDoManager.js\");\n/* harmony import */ var _domManager_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domManager.js */ \"./src/domManager.js\");\n\n\n\n\n\nfunction importAll(r) {\n    let images = {};\n    r.keys().map((item, index) => { images[item.replace('./', '')] = r(item); });\n    return images;\n  }\n\nconst images = importAll(__webpack_require__(\"./src/images sync \\\\.(png%7Csvg%7Cjpg%7Cjpeg%7Cgif)$\"));\n\nconst fullToDos = JSON.parse(localStorage.getItem('fullToDos')) || {\n    'Home': [],\n    'Today': [],\n    'Week': [],\n    'Project 1':[],\n    'Project 2':[],\n    'Project 3':[]                                              \n    }\n\nif (!localStorage.getItem('fullToDos')) {\n\n    fullToDos['Home'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Home Title', 'Description of home task 1', '2022-10-31', 'low', 'Home', false));\n    fullToDos['Home'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Home to do Title 2', 'Description of home task 2', '2022-11-31', 'medium', 'Home', false));\n    fullToDos['Home'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Home to do Title 3', 'Description of home task 3', '2022-9-31', 'high', 'Home', false));\n\n    fullToDos['Today'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Today take a shower', 'Description of taking a shower?', '2022-12-31', 'low', 'Today', false));\n    fullToDos['Today'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Today brush teeth', 'Description of brushing teeth', '2022-10-31', 'low', 'Today', false));\n\n    fullToDos['Week'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Week Title', 'Description of week task 1', '2022-9-31', 'low', 'Week', false));\n    fullToDos['Week'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Week Title 2', 'Description of week task 2', '2022-10-31', 'low', 'Week', false));\n\n    fullToDos['Project 1'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Project 1 Title', 'Description of proj 1 task 1', '2022-10-31', 'low', 'Project 1', false));\n\n    fullToDos['Project 2'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Project 2 Title', 'Description of proj 2 task 1', '2022-10-31', 'low', 'Project 2', false));\n\n    fullToDos['Project 3'].push(_toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.createToDo('Project 3 Title', 'Description of proj 3 task 1', '2022-10-31', 'low', 'Project 3', false));\n}\n\nfor(const list in fullToDos) {\n  _toDoManager_js__WEBPACK_IMPORTED_MODULE_1__.toDoManager.sortListByDate(fullToDos[list]);\n}\nconst toDoListDisplay = document.querySelector('.to-do-list');\nconst navProjectsDisplay = document.querySelector('.projects-container');\nconst homeNav = document.querySelector('.home-nav');\nconst todayNav = document.querySelector('.today-nav');\nconst weekNav = document.querySelector('.week-nav');\n\n_domManager_js__WEBPACK_IMPORTED_MODULE_2__.domManager.displayToDos(fullToDos, toDoListDisplay,true);\n\nconsole.log(\"first \" + toDoListDisplay);\n_domManager_js__WEBPACK_IMPORTED_MODULE_2__.domManager.displayNav(fullToDos, navProjectsDisplay, toDoListDisplay);\n// console.log(fullToDos);\n\nhomeNav.addEventListener('click', () => {\n    _domManager_js__WEBPACK_IMPORTED_MODULE_2__.domManager.setCurrentProject('Home');\n    _domManager_js__WEBPACK_IMPORTED_MODULE_2__.domManager.displayToDos(fullToDos,toDoListDisplay,true);\n});\ntodayNav.addEventListener('click', () => {\n  _domManager_js__WEBPACK_IMPORTED_MODULE_2__.domManager.setCurrentProject('Today');\n  _domManager_js__WEBPACK_IMPORTED_MODULE_2__.domManager.displayToDos(fullToDos['Today'],toDoListDisplay,true);\n});\nweekNav.addEventListener('click', () => {\n  _domManager_js__WEBPACK_IMPORTED_MODULE_2__.domManager.setCurrentProject('Week');\n  _domManager_js__WEBPACK_IMPORTED_MODULE_2__.domManager.displayToDos(fullToDos['Week'],toDoListDisplay,true);\n});\n\nconsole.log('hello');\n\n\n//# sourceURL=webpack://odin-todo/./src/index.js?");
...
"use strict";
eval("module.exports = __webpack_require__.p + \"132696644e79a1f05c3b.png\";\n\n//# sourceURL=webpack://odin-todo/./src/images/add.png?");
